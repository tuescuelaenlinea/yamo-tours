...
const accommodations = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 28,
    image: '/images/hospedaje/glamping-geronimo/1.jpg',
    emoji: '⛺',
    capacity: 2,
    bedrooms: 1,
    bathrooms: 1,
...
<section className="relative h-[300px] flex items-center justify-center overflow-hidden">
  ...
  <div className="absolute inset-0 z-0">
    <Image
      src="/images/hospedaje/eteka/eteka-vista-mar-evolucion.jpg" // ⚠️ CAMBIA ESTA RUTA por tu imagen real (ej: /images/islas/rosario-aerea.jpg)
